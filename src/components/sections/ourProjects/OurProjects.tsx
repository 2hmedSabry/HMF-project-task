                ...
                <div className="bg-white rounded-[32px] overflow-hidden relative">
                    ...
                    {isAnimating && previousProject && (
                        ...
                        >
                            <div className="w-[50%] flex flex-col pr-[32px] ">
                                ...
                                <span className="flex flex-row items-center gap-1 mb-3 text-lg font-bold"><Location />مدينة {previousProject.city}</span>
                    ...
                    >
                        <div className="w-[50%] flex flex-col pr-[32px] ">
                            ...
                            <span className="flex flex-row items-center gap-1 mb-3 text-lg font-bold"><Location />مدينة {currentProject.city}</span>
