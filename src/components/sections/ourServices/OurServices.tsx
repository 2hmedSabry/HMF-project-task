            ...
            <div className="flex flex-row justify-between ">
                ...
                <div className=" grid grid-cols-2 gap-4">
                    {SERVICES_CARDS.map((service, index) => (
                        <div key={index} className="flex flex-col shadow-[0px_0px_2px_0px_#00000040] w-[394px] mb-4 rounded-[16px] bg-white overflow-hidden">
                            <div className="relative w-full h-[260px]">
                                <Image src={service.image} alt={service.title} fill sizes="(max-width: 768px) 100vw, 394px" className="rounded-t-[16px] object-cover" />
                            </div>
