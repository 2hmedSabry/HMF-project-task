            ...
            <div className="container mx-auto py-10 pt-19 flex flex-row gap-5">
                <div className="w-fit flex flex-col justify-between gap-29">
                    <div className="flex flex-col gap-6 p-2">
                        ...
                        <SlideUpAnimation>
                            <Link href={FOOTER_CONTENT.about.ctaLink} className="text-[#B2B2B2] pt-1  text-xl font-bold inline-flex items-center gap-2 " >{FOOTER_CONTENT.about.ctaText}<AboutArrowIcon /></Link>
                        </SlideUpAnimation>
