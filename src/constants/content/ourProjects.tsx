...
export const OUR_PROJECTS_CONTENT: { title: string; list: ProjectItem[] } = {
    ...
    list: [
        ...
        },
        {
            ...
            description: "يتميز الكورنيش بتصميمه العصري,والذي يجمع بين الطابع المعماري المستوحى من طبيعة المنطقة البحرية والأصالة السعودية,ويمتد الكورنيش علي طول ساحل البحر الأحمر، مما يتيح لزواره الاستمتاع بإطلالات بانورامية علي البحر. ويشمل تصميم الكورنيش مسارات مخصصة للدرجات الهوائية والمشاة، مع أشجار نخيل ومظلات عصرية توفر الظل علي امتداد المسار.",
            cta: "شاهد المزيد",
            ctaLink: "/",
            image: "/ourProjects/image/43b01e1eca29ce4704571069f563bd66f461d026.jpg"
        },
